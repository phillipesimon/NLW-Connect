...
const showInvite = (userData) => {
  app.innerHTML = `
   <main>
        ...
        <p>
          Convide mais pessoas e concorra a prêmios! <br />Compartilher o link e
        ...
        <div class="input-group">
          ...
          <input type="text" id="link" value="https://example.com?ref=${
            userData.ref
          }" disabled />
        </div>
      </main>
          ...
          <main>
            <section class="about">
                ...
                <p>
                  ...
                  apaixonadas por criar soluções inovadoras e compartilhar conhecimento.
                   Vamos mergulhar nas tendências mais recentes em desenvolvimento de 
                   software, arquitetura de sistemas e tecnologias emergentes, 
